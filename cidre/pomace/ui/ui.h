...
Class UI_DROP_PROPOSAL;
Class UI_DROP_INTERACTION;
Class UI_SELECTION_FEEDBACK_GENERATOR;
...
static void ui_initializer(void)
{
    ...
    if (!initialized) {
        ...
        UI_DROP_PROPOSAL = NSClassFromString(@"UIDropProposal");
        UI_DROP_INTERACTION = NSClassFromString(@"UIDropInteraction");
        UI_SELECTION_FEEDBACK_GENERATOR = NSClassFromString(@"UISelectionFeedbackGenerator");
