    ...
    S: State<Unit>,
{
    ...
    pub fn is_enabled(&self, scope: Scope, bus: u32) -> Result<bool, os::Status> {
        let res = self
            .unit()
    ...
    #[inline]
    pub fn set_enabled(&mut self, scope: Scope, bus: u32, val: bool) -> Result<(), os::Status> {
    ...
    #[inline]
    pub fn set_output_enabled(&mut self, val: bool) -> Result<(), os::Status> {
        self.set_enabled(Scope::OUTPUT, 0, val)
    }

    #[inline]
    pub fn set_input_enabled(&mut self, bus: u32, val: bool) -> Result<(), os::Status> {
        self.set_enabled(Scope::INPUT, bus, val)
    }

    #[inline]
    pub fn is_output_enabled(&self) -> Result<bool, os::Status> {
        self.is_enabled(Scope::OUTPUT, 0)
    }

    #[inline]
    pub fn is_input_enabled(&self, bus: u32) -> Result<bool, os::Status> {
        self.is_enabled(Scope::INPUT, bus)
    }

    #[inline]
    pub fn volume(&self, scope: Scope, bus: u32) -> Result<f32, os::Status> {
        self.unit()
    ...
    #[inline]
    pub fn set_output_volume(&mut self, val: f32) -> Result<(), os::Status> {
        self.set_output_volume_at(val, 0)
    }

    #[inline]
    pub fn output_volume(&self) -> Result<f32, os::Status> {
        self.volume(Scope::OUTPUT, 0)
    }

    #[inline]
    pub fn set_input_volume_at(
        &mut self,
        bus: u32,
        val: f32,
        frame_offset: u32,
    ...
    #[inline]
    pub fn set_input_volume(&mut self, bus: u32, val: f32) -> Result<(), os::Status> {
    ...
    #[inline]
    pub fn input_volume(&self, bus: u32) -> Result<f32, os::Status> {
        self.volume(Scope::INPUT, bus)
    }

    #[inline]
    pub fn is_metering_enabled(&self, scope: Scope, bus: u32) -> Result<bool, os::Status> {
        let res: u32 = self
            .unit()
    ...
    #[inline]
    pub fn set_output_metering_enabled(&mut self, val: bool) -> Result<(), os::Status> {
        self.set_metering_enabled(Scope::OUTPUT, 0, val)
    }

    #[inline]
    pub fn set_input_metering_enabled(&mut self, bus: u32, val: bool) -> Result<(), os::Status> {
        self.set_metering_enabled(Scope::INPUT, bus, val)
    }

    #[inline]
    pub fn is_output_metering_enabled(&self) -> Result<bool, os::Status> {
        self.is_metering_enabled(Scope::OUTPUT, 0)
    }

    #[inline]
    pub fn is_input_metering_enabled(&self, bus: u32) -> Result<bool, os::Status> {
        self.is_metering_enabled(Scope::INPUT, bus)
    }

    /// level in dB
    #[inline]
    pub fn pre_avg_power(&self, scope: Scope, bus: u32, channel: u8) -> Result<f32, os::Status> {
    ...
    /// level in dB
    #[inline]
    pub fn pre_input_avg_power(&self, bus: u32, channel: u8) -> Result<f32, os::Status> {
        self.pre_avg_power(Scope::INPUT, bus, channel)
    }

    /// level in dB
    #[inline]
    pub fn pre_output_avg_power(&self, channel: u8) -> Result<f32, os::Status> {
        self.pre_avg_power(Scope::OUTPUT, 0, channel)
    }

    /// level in dB
    #[inline]
    pub fn pre_peak_hold_level(
        &self,
        scope: Scope,
        bus: u32,
        channel: u8,
    ) -> Result<f32, os::Status> {
    ...
    /// level in dB
    #[inline]
    pub fn pre_input_peak_hold_level(&self, bus: u32, channel: u8) -> Result<f32, os::Status> {
        self.pre_peak_hold_level(Scope::INPUT, bus, channel)
    }

    /// level in dB
    #[inline]
    pub fn pre_output_peak_hold_level(&self, channel: u8) -> Result<f32, os::Status> {
        self.pre_peak_hold_level(Scope::OUTPUT, 0, channel)
    }

    /// level in dB
    #[inline]
    pub fn post_avg_power(&self, scope: Scope, bus: u32, channel: u8) -> Result<f32, os::Status> {
    ...
    /// level in dB
    #[inline]
    pub fn post_input_avg_power(&self, bus: u32, channel: u8) -> Result<f32, os::Status> {
        self.post_avg_power(Scope::INPUT, bus, channel)
    }

    /// level in dB
    #[inline]
    pub fn post_output_avg_power(&self, channel: u8) -> Result<f32, os::Status> {
        self.post_avg_power(Scope::OUTPUT, 0, channel)
    }

    /// level in dB
    #[inline]
    pub fn post_peak_hold_level(
        &self,
        scope: Scope,
        bus: u32,
        channel: u8,
    ...
    /// level in dB
    #[inline]
    pub fn post_input_peak_hold_level(&self, bus: u32, channel: u8) -> Result<f32, os::Status> {
        self.post_peak_hold_level(Scope::INPUT, bus, channel)
    }

    /// level in dB
    #[inline]
    pub fn post_output_peak_hold_level(&self, channel: u8) -> Result<f32, os::Status> {
...
impl MultiChannelMixer<InitializedState> {
    pub fn deallocate_resources(self) -> Result<MultiChannelMixer<UninitializedState>, os::Status> {
