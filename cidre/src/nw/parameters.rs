use crate::{api, arc, blocks, define_obj_type, ns, nw};
...
impl Params {
    ...
    #[api::available(macos = 26.0, ios = 26.0, watchos = 26.0, tvos = 26.0, visionos = 26.0)]
    pub fn allow_ultra_constrained(&mut self) -> bool {
        unsafe { nw_parameters_get_allow_ultra_constrained(self) }
    }
    #[doc(alias = "nw_parameters_set_allow_ultra_constrained")]
    #[api::available(macos = 26.0, ios = 26.0, watchos = 26.0, tvos = 26.0, visionos = 26.0)]
    pub fn set_allow_ultra_constrained(&mut self, val: bool) {
        unsafe { nw_parameters_set_allow_ultra_constrained(self, val) }
    }
    ...
    #[inline]
    pub fn set_reuse_local_address(&mut self, val: bool) {
        unsafe { nw_parameters_set_reuse_local_address(self, val) }
    }

    #[doc(alias = "nw_parameters_copy_local_endpoint")]
    #[inline]
    pub fn local_endpoint(&self) -> Option<arc::Retained<nw::Endpoint>> {
        unsafe { nw_parameters_copy_local_endpoint(self) }
    }

    #[doc(alias = "nw_parameters_set_local_endpoint")]
    #[inline]
    pub fn set_local_endpoint(&mut self, val: Option<&nw::Endpoint>) {
        unsafe { nw_parameters_set_local_endpoint(self, val) }
    }
    ...
    #[inline]
    pub fn set_include_peer_to_peer(&mut self, val: bool) {
        unsafe {
            nw_parameters_set_include_peer_to_peer(self, val);
        }
    }
}
...
#[doc(alias = "nw_multipath_service_t")]
...
impl Params {
    ...
    #[inline]
    pub fn set_fast_open_enabled(&mut self, val: bool) {
        unsafe {
            nw_parameters_set_fast_open_enabled(self, val);
        }
    }
}
...
unsafe extern "C-unwind" {
    ...
    #[api::available(macos = 26.0, ios = 26.0, watchos = 26.0, tvos = 26.0, visionos = 26.0)]
    fn nw_parameters_get_allow_ultra_constrained(params: &Params) -> bool;

    fn nw_parameters_set_reuse_local_address(params: &mut Params, val: bool);
    fn nw_parameters_get_reuse_local_address(params: &Params) -> bool;

    fn nw_parameters_set_local_endpoint(params: &mut Params, val: Option<&nw::Endpoint>);
    fn nw_parameters_copy_local_endpoint(params: &Params) -> Option<arc::R<nw::Endpoint>>;
