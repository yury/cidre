...
impl AdamWOptimizer {
    ...
    pub fn with_descriptor_ar(desc: &mlc::OptimizerDescriptor) -> arc::Rar<Self>;

    #[objc::cls_rar_retain]
    pub fn with_descriptor(desc: &mlc::OptimizerDescriptor) -> arc::R<Self>;
