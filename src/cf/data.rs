...
impl Data {
    ...
    pub fn as_slice(&self) -> &[u8] {
        unsafe { &*slice_from_raw_parts(self.as_bytes_ptr() as _, self.len()) }
    }
}
...
impl MutableData {
    ...
    /// use `as_slice_mut()`
    #[inline]
    pub unsafe fn as_bytes_ptr_mut(&mut self) -> *mut u8 {
    ...
    pub fn as_slice_mut(&mut self) -> &mut [u8] {
        unsafe { &mut *slice_from_raw_parts_mut(self.as_bytes_ptr_mut() as *mut u8, self.len()) }
    }
}
