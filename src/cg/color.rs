...
impl Color {
    ...
    /// ```
    pub fn generic_rgb<'c>(red: cg::Float, green: cg::Float, blue: cg::Float, alpha: cg::Float) -> Retained<'c, Color> {
...
extern "C" {
    ...
    fn CGColorCreateGenericRGB<'c>(red: cg::Float, green: cg::Float, blue: cg::Float, alpha: cg::Float) -> Retained<'c, Color>;
