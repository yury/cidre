...
impl Time {
    pub fn with_timestamp<'a>(ts: &cat::AudioTimeStamp, sample_rate: f64) -> cf::Retained<'a, Time> {
        unsafe {
            AVAudioTime_timeWithAudioTimeStamp_sampleRate(ts, sample_rate)
        }
    }

    pub fn with_host_time<'a>(host_time: u64) -> cf::Retained<'a, Time> {
        unsafe {
            AVAudioTime_timeWithHostTime(host_time)
        }
    }

    pub fn with_host_time_sample_rate_at_rate<'a>(host_time: u64, sample_time: FramePosition, at_rate: f64) -> cf::Retained<'a, Time> {
        unsafe {
            AVAudioTime_timeWithHostTime_sampleTime_atRate(host_time, sample_time, at_rate)
        }
    }
    
    pub fn with_sample_time<'a>(time: FramePosition, at_rate: f64) -> cf::Retained<'a, Time> {
        unsafe {
            AVAudioTime_timeWithSampleTime_atRate(time, at_rate)
        }
    }
    ...
    pub fn extrapolate_time_from_anchor<'a>(&self, anchor: &Time) -> Option<cf::Retained<'a, Time>> {
        unsafe {
            rsel_extrapolateTimeFromAnchor(self, anchor)
        }
    }
}
...
extern "C" {
    fn AVAudioTime_timeWithAudioTimeStamp_sampleRate<'a>(ts: &cat::AudioTimeStamp, sample_rate: f64) -> cf::Retained<'a, Time>;
    fn AVAudioTime_timeWithHostTime<'a>(host_time: u64) -> cf::Retained<'a, Time>;
    fn AVAudioTime_timeWithSampleTime_atRate<'a>(sample_time: FramePosition, sample_rate: f64) -> cf::Retained<'a, Time>;
    fn AVAudioTime_timeWithHostTime_sampleTime_atRate<'a>(host_time: u64, sample_time: FramePosition, at_rate: f64) -> cf::Retained<'a, Time>;
    ...
    fn rsel_extrapolateTimeFromAnchor<'a>(time: &Time, anchor: &Time) -> Option<cf::Retained<'a, Time>>;  
}
